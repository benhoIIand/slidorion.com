		...
		slidorion: function(options) {
			...
			return this.each(function() {
				...
				if(sliderCount==accordionCount){
					...
					$(window).resize(accordionHeaderHeight);
				...
				function accordionHeaderHeight() {
                    var accordHeight = $('#accordion').height();
                    var accords = accordionCount;
                    var headerHeight = 100/accords;
					console.log(headerHeight);
                    $('#accordion .link-header', obj).css({
